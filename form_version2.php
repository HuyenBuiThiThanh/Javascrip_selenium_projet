...
<body class="bg-light">
                ...
                <form class="needs-validation" novalidate="" id="checkoutFormValid">
                    ...
                    <div class="row">
                        <div class="col-md-5 mb-3">
                            ...
                            <select class="custom-select d-block w-100" id="country" required="" onclick="updateStates()" dichoi="dlddl">
    ...
    <script>
        ...
        // Thêm tùy chọn tương ứng với country được chọn
        if (selectedCountry === 'country1') {
            addOption(stateSelect, 'state1-1', 'State 1-1');
            addOption(stateSelect, 'state1-2', 'State 1-2');
            addOption(stateSelect, 'state1-3', 'State 1-3');
        } else if (selectedCountry === 'country2') {
            addOption(stateSelect, 'state2-1', 'State 2-1');
            addOption(stateSelect, 'state2-2', 'State 2-2');
            addOption(stateSelect, 'state2-3', 'State 2-3');
            addOption(stateSelect, 'state2-4', 'State 2-4');
        }
        }
